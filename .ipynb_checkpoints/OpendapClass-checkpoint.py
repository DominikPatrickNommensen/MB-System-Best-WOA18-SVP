...
class AccessOpendap18():
    ...
    base_url = 'https://www.ncei.noaa.gov/thredds-ocean/dodsC/ncei/woa/{0}/{1}/{2}/woa18_{1}_{3}{4}_{5}.nc'
...
class AccessOpendap23():
    
    base_url = 'https://www.ncei.noaa.gov/thredds-ocean/dodsC/woa23/DATA/{0}/netcdf/{1}/{2}/woa23_{1}_{3}{4}_{5}.nc'
